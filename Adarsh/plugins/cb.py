...
import pyrogram
from pyrogram import Client as CODE_X_MANIA
...
@CODE_X_MANIA.on_callback_query(filters.create(lambda _, __, query: query.data.startswith("rename")))
...
@CODE_X_MANIA.on_message(filters.private & filters.reply & filters.text)
...
@CODE_X_MANIA.on_callback_query(filters.create(lambda _, __, query: query.data.startswith("cancel")))
...
@CODE_X_MANIA.on_callback_query(filters.create(lambda _, __, query: query.data.startswith("convert")))
